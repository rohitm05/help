...
$query="select username,userid from users1";
...
<table class="table table-striped tab" border="4" align="center" >
	...
	<?php while ($arr=mysqli_fetch_array($r,MYSQLI_BOTH)): ?>
		<tr>
			...
			<td class="tab"><a href="edit1.php?userid=<?php echo $arr['userid'];?>"><i class="fas fa-user-edit i"></i></a></td>
			<td class="tab"><a href="manage1.php?userid=<?php echo $arr['userid'];?>"><i class="fas fa-trash-alt i"></i></a></td>
		</tr>	
		<?php endwhile; ?>
</table>
