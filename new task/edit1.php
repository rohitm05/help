...
$query="select * from users1 where userid='".$_REQUEST['userid']."'";
...
<body>
   <div class="container">
    ...
    <div  border="2"> 
<form  name="frm-update" method="post"  action="update1.php" enctype="multipart/form-data"  >
   <table   class="demo-table"  >
    <tr>
   <td class="td1">User image</td>
   <td>
      <img src="uploads/<?php echo($arr['image']) ?>" style="height: 50px; width: 50px;">
      <input type="file" class="demoInputBox" name="fileToUpload" id="fileToUpload" value="<?php echo "uploads/".($arr['image']) ?>">
   </td>
   </tr>
   <tr>
